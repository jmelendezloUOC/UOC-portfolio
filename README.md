# Portafolio UOC - Juan Pedro Meléndez Lobo
El repositorio es una recopilación de los proyectos que realizo durante mis estudios en la Universitat Oberta de Catalunya (UOC) que se irá actualizando a medida que avance en el grado y complete nuevos proyectos.

# Contenido del Repositorio
- Proyectos relacionados con gestión de proyectos, trabajo en equipo y planificación.
- Posibles prácticas requeridas por la Universitat Oberta de Catalunya (UOC).
- Proyectos de asignaturas que puedan ser relevantes para mi trayectoria dentro de la Universitat Oberta de Catalunya (UOC).
